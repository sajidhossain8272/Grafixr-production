      ...
      >
        ...
        <div className="flex flex-col items-center justify-center mb-4">
          <span className="flex items-center gap-2">
            <Image
              ...
              alt="Logo"
              className="w-60 h-60 mr-2 select-none pointer-events-none"
              draggable={false}
            />
          </span>
        </div>
        ...
        <div className="w-full flex flex-col md:flex-row items-center justify-between mt-6 gap-5 md:gap-0">
          ...
          <nav className="flex flex-col md:flex-row gap-3 md:gap-8 items-center">
            <Link
              href="/about"
              className="text-white/80 hover:text-cyan-300 font-semibold text-lg transition"
            >
              About Us
            </Link>
            <Link
          ...
          <div className="flex flex-row gap-6 items-center mt-5 md:mt-0">
            ...
            <a
              href="https://bd.linkedin.com/in/grafixr"
              target="_blank"
              rel="noopener noreferrer"
