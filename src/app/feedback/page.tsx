            ...
            return (
              <motion.div
                ...
                whileHover={{
                  scale: 1.03,
                  boxShadow:
                    "0 8px 80px 2px #31ffe655,0 1px 44px 2px #fd43ad44",
                }}
                className={`
                  ...
                  ${
                    isOdd
                      ? "md:rotate-[5deg] md:-mt-16 md:mb-8"
                      : "md:-rotate-[3deg] md:mb-16"
                  }
                `}
                style={{
                  fontFamily: "Montserrat, Arial, sans-serif",
              ...
              >
                ...
                {idx === 1 && (
                  <motion.img
                    src='/Cylinder.png'
                    alt='Cylinder'
                    className='fixed md:absolute right-8 md:-right-20 bottom-40 md:bottom-40 w-[100px] md:w-[120px] z-30 select-none pointer-events-none'
                    draggable={false}
                    initial={{ y: 0, x: 0 }}
                    animate={{
                      y: [0, -18, 0, 10, 0],
                ...
                {/* Name */}
                <h3
                  className='text-2xl md:text-3xl font-extrabold text-white mt-8 mb-1 text-center drop-shadow'
                ...
                <div className='flex justify-center my-2 mb-3 gap-1 relative'>
                  {[...Array(5)].map((_, i) => (
                    <span className='relative' key={i}>
                      <FaStar
                        className={`${
                          i < r.rating ? "text-cyan-400" : "text-gray-700"
                        } text-2xl drop-shadow`}
                        style={{
                          filter:
                            i < r.rating
                              ? "drop-shadow(0 0 6px #2ed1fa77)"
                              : "none",
