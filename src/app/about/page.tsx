...
export default function AboutPage() {
  ...
  return (
    <section className='pt-16 md:pt-20 w-full flex items-center justify-center bg-[#18181B] px-1 sm:px-2 relative overflow-hidden'>
      {/* Modal */}
      {showModal && (
      ...
      <div className='w-full max-w-6xl bg-black/90 rounded-[22px] sm:rounded-[32px] border-2 border-white/60 px-2 sm:px-6 md:px-10 py-5 sm:py-10 md:py-14 mx-auto relative shadow-[0_0_80px_10px_rgba(56,246,255,0.09)] overflow-visible backdrop-blur-xl'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-8 md:gap-0 justify-between relative z-10 min-h-[360px] sm:min-h-[400px]'>
          ...
          <motion.div
            ...
            className='flex-1 flex flex-col items-center justify-center pr-1 sm:pr-3 pt-6 md:pt-0 w-full min-w-0'
          >
            <div className='text-white/90 text-base sm:text-[1.08rem] max-w-[92vw] sm:max-w-md leading-relaxed font-medium drop-shadow-md'>
              Welcome to Grafixr — a creative digital agency founded by Rony in
              2019. What started as a small design studio under the name RonyQ
              has now evolved into a full-service agency offering a wide range
              of online solutions including Graphic Design, Website Development,
              Digital Marketing, Branding, and Creative Content Production. At
              Grafixr, we believe every business deserves a strong visual
              identity and an effective online presence. Our mission is simple —
              to help brands grow through creative design, smart strategy, and
              result-driven digital marketing. Whether you’re a startup looking
              to build your first website, or an established brand aiming to
              scale online — we’ve got you covered. From idea to execution, we
              handle everything with care, creativity, and professionalism.
              Let’s work together to turn your ideas into digital reality. 🚀
            </div>
          </motion.div>
        </div>
