...
const CTASection: React.FC = () => {
  return (
    <section className="flex justify-center items-center py-14 px-2 bg-black dark:bg-white transition-colors duration-500">
      <div className="relative w-full max-w-[1500px] rounded-[48px] border border-white/70 dark:border-black/10 px-6 md:px-0 py-12 md:py-20 bg-black dark:bg-white flex flex-col items-center text-center overflow-hidden">
        {/* Left Cube */}
        <img
          src="/Cube.png"
          alt="Cube"
        ...
        <div className="relative z-20 flex flex-col items-center w-full">
          <h2
            className="text-[2.7rem] sm:text-[4.5rem] font-extrabold tracking-tight text-white dark:text-black mb-1"
            style={{ fontFamily: "Montserrat, Arial, sans-serif" }}
          >
            Order Now
          </h2>
          <div className="text-lg md:text-xl font-semibold mb-8 text-white dark:text-black">
